@{
    ...
    FunctionsToExport = @('Initialize-Repository', 'Get-GitDir', 'Set-Repository', 'Switch-GitBranch', 'Add-TrackingBranch', 'Remove-Branch', 'Read-Repository', 'Publish-Develop', 'Publish-DevelopAlt', 'Update-Develop', 'Update-DevelopAlt', 'Update-Branch', 'Update-Repository', 'Update-DevelopBranch', 'Optimize-Repository', 'Publish-Repository', 'Reset-RepoCache')
