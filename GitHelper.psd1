@{
    ...
    FunctionsToExport = @('Initialize-Repository', 'Get-GitDir', 'Set-Repository', 'Switch-GitBranch', 'Add-TrackingBranch', 'Remove-Branch', 'Publish-Develop', 'Publish-DevelopAlt', 'Update-Develop', 'Update-DevelopAlt', 'Read-Repository', 'Update-Branch', 'Update-Repository', 'Update-DevelopBranch', 'Optimize-Repository', 'Publish-Repository', 'Reset-RepoCache')
    ...
    AliasesToExport = @('Init-Repo', 'gitdir', 'Set-Repo', 'repo', 'checkout', 'gittrack', 'gitdrop', 'pushdev', 'pushdeva', 'pulldev', 'pulldeva', 'Read-Repo', 'Update-Repo', 'Update-Dev', 'Sync-Dev', 'Optimize-Repo', 'Pub-Repo', 'gitfix')
